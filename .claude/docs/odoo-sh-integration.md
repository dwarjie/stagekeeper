...
e.g. `/project/sample-project/branches/staging/history`.
...
- `store.repo.project_name` → `"sample-project"`
- `store.repo.name` → `"sample_project_odoo"`
...
```jsonc
{
	...
	"build": {
		...
		"stage": "staging",
		"url": "https://sample-project-staging-33717728.dev.odoo.com",
	},
